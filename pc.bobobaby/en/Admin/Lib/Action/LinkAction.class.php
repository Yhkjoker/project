	...
	public function index(){
	   $linkageid=intval($_GET['linkageid']);
	   	import('ORG.Util.Page');
			...
			$show=$page->show();			
			$link_list=$this->link_db->field("a.name,a.linkageid,a.listorder,b.catname,b.catid")->table("en_linkage a,en_category b")->where("a.catid=b.catid")->limit($page->firstRow.','.$page->listRows)->select();
