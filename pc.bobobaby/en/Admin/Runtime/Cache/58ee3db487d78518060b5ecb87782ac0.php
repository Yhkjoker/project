...
<div id="content">
<div id="breadcrumb"> <a href="__APP__/Index/index/cls/1" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>主页</a><span class="nadd">->&nbsp;&nbsp;&nbsp;添加信息</span></div>
<!--breadcrumbs-->
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
        ...
        <div class="widget-box">
          ...
          <form class="myForm" action="__APP__/Index/doPicture/action/add" method="post">
           ...
           <table class="table table-bordered table-striped">
			...
			<input type="text" id="url3" name="info[picurl]" value="" class="ke-input-text"/> <input type="button" id="image3" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
</td></tr>
			<tr>
		<tr><td><span>上传小图：</span></td><td>
			<input type="text" id="url1" name="info[picwzurl]" value=""  class="ke-input-text"/> <input type="button" id="image1" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
</td></tr>

		<tr><td><span>连接地址：</span></td><td>
					<input type="text" name="info[vidurl]" value=""  class="ke-input-text"/> 例：http://www.baidu.com
		</td></tr>
			<tr>
