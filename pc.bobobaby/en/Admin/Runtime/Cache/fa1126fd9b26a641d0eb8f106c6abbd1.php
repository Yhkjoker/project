...
<div id="content">
<div id="breadcrumb"> <a href="__APP__/Index/index" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>主页</a><span class="nadd">->&nbsp;&nbsp;&nbsp;修改</span></div>
<!--breadcrumbs-->
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
        ...
        <div class="widget-box">
          ...
          <form class="myForm" action="__APP__/Video/doVideo/action/edit/vid/<?php echo ($arr["vid"]); ?>" method="post">
           ...
           <table class="table table-bordered table-striped">
			...
			<tr>
			  ...
			  <td>
			  <input type="text" name="info[vtitle]" datatype="*" nullmsg="标题为空" value="<?php echo ($arr["vtitle"]); ?>"/>
			...
			<tr>
			  ...
			  <td>
			  <input type="text" name="info[ftitle]" datatype="*" nullmsg="标题为空" value="<?php echo ($arr["ftitle"]); ?>"/>
		...
		<tr>
			  ...
			  <td>
				<input type="text" name="info[vurl]" id="url" value="<?php echo ($arr["vurl"]); ?>" /><input type="button" id="insertfile" value="选择文件" />mp4，pdf格式
			  </td>
			  ...
			  <td>
				  <input type="text" name="info[vfurl]" id="urlone" value="<?php echo ($arr["vfurl"]); ?>"/><input type="button" id="insertfileone" value="选择文件" />flv格式
			  </td>
			 ...
			 <tr><td><span>上传图片：</span></td><td>	<input type="text" id="url1" name="info[picurlpc]"  class="ke-input-text" value="<?php echo ($arr["picurlpc"]); ?>"/> <input type="button" id="image1" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
				</td></tr>
			 <tr><td><span>上传文字图片：</span></td><td>	<input type="text" id="url2" name="info[vpurlwz]"  class="ke-input-text" value="<?php echo ($arr["vpurlwz"]); ?>"/> <input type="button" id="image2" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
				</td></tr>

			<tr><td><span>上传导航图片：</span></td><td>
			<input type="text" id="url3" name="info[headerpic]" value="<?php echo ($arr["headerpic"]); ?>" class="ke-input-text"/> <input type="button" id="image3" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
		</td></tr>
			...
			<tr>
			  ...
			  <td><input type='text' name='info[inputtime]' value="<?php echo date("Y-m-d H:i:s",$arr['inputtime']);?>" class='text-input small-input Wdate'  onBlur="FireEvent(this,'onchange');" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})"  /></td>
		  ...
		  $('.myForm').Validform({
			...
			callback:function(data){
				...
				if(data.status=='y'){
					...
					setTimeout(function(){window.location="__APP__/Video/video/catid/<?php echo ($arr["catid"]); ?>/cls/2";},1000);
