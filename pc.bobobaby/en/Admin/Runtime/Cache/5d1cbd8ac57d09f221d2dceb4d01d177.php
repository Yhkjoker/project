  ...
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
      ...
      <ul class="quick-actions">
       ...
       <li class="bg_lb"> <a href="__APP__/Product/addProduct/catid/<?php echo ($catid); ?>/cls/2"> <i class="icon-pencil"></i>新增</a></li>
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
        ...
        <div class="widget-box">
          ...
          <?php if(is_array($pro_list)): foreach($pro_list as $key=>$v): ?><tr>
				...
				<input type="checkbox" name="status" value="<?php echo ($v["status"]); ?>" <?php if($v["status"] == 1): ?>checked<?php endif; ?> onclick="chk(this.checked?1:0,<?php echo ($v["id"]); ?>)"/><span class="xs<?php echo ($v["id"]); ?>"><?php if($v["status"] == 1): ?>已显示<?php else: ?>未显示<?php endif; ?></span>
				...
				<input type="checkbox" name="status" value="<?php echo ($v["xqstatus"]); ?>" <?php if($v["xqstatus"] == 1): ?>checked<?php endif; ?> onclick="chkxq(this.checked?1:0,<?php echo ($v["id"]); ?>)"/><span class="xsxq<?php echo ($v["id"]); ?>"><?php if($v["xqstatus"] == 1): ?>显示<?php else: ?>关闭<?php endif; ?></span>
				...
				<td style="text-align:center;"><?php echo date("Y-m-d H:i:s",$v['inputtime']); ?></td>
	 		  	...
	 		  	<a href="__APP__/Product/upProduct/catid/<?php echo ($catid); ?>/id/<?php echo ($v["id"]); ?>/cls/2" class="btn btn-primary btn-mini">编辑</a>
