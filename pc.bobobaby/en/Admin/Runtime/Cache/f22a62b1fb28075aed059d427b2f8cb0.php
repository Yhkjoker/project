  ...
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
      ...
      <ul class="quick-actions">
       ...
       <li class="bg_lb"> <a href="__APP__/Try/addQues/cls/8"> <i class="icon-pencil"></i>新增</a></li>
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
        ...
        <div class="widget-box">
          ...
          <?php if(is_array($problem_list)): foreach($problem_list as $key=>$v): ?><tr>
				...
				<td style="text-align:center;">
	 		  	...
	 		  	<a href="__APP__/Try/upQues/id/<?php echo ($v["id"]); ?>/cls/7" class="btn btn-primary btn-mini">编辑</a>
