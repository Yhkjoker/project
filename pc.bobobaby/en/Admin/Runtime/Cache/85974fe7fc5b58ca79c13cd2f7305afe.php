...
<div id="content">
<div id="breadcrumb"> <a href="__APP__/Index/index/cls/1" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>主页</a><span class="nadd">->&nbsp;&nbsp;&nbsp;添加问卷</span></div>
<!--breadcrumbs-->
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
        ...
        <div class="widget-box">
          ...
          <form class="myForm" action="__APP__/Try/doQuestionnaire/action/add" method="post">
           ...
           <table class="table table-bordered table-striped">
			...
			<tr>
			  ...
			  <td><input type="text" name="info[title]" datatype="*" nullmsg="标题为空"/>
				...
				<tr><td><span> 问卷信息：</span><br/><span style="color:#f00;">注:<br/>字段：只能输入英文字母且一份问卷中的字段名称不能重复;</span><br/><span style="color:#f00;">选项：填写的每个选项必须以-分隔;<br/>(例：男-女)</span></td>
				<td>
					...
					<table width="100%" >
							...
							<tbody>
							 ...
							 <tbody id="addTrr">
								<tr id="p0">
									<td>
											<input type="text"  style="width:100px;" name="info[quesname][]"/>	
									</td>
								
									<td>
											<input type="text"  style="width:50px;"  name="info[fieldname][]"/>
									</td>
							
									 <td >
										<select name="info[typeid][]" style="width:70px;margin:0px">
								  		...
								  		<td>
											<textarea name="info[content][]" style="margin:0px;width: 414px; height: 42px; "></textarea>
