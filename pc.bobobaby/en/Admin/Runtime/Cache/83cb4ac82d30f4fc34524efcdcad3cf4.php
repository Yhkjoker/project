  ...
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
      ...
      <ul class="quick-actions">
	   ...
	   <li class="bg_ls"><a href="__APP__/Link/addLink/cls/3"> <i class="icon-dashboard"></i>新增</a></li>	
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
        ...
        <div class="widget-box">
		  ...
		  <form action="__URL__/conOrder" method="post">
             ...
             <thead>
              ...
              <tr>
                ...
                <th width="10%">一级菜单名称</th>
								<th width="10%">二级菜单名称</th>
          ...
          <?php if(is_array($link_list)): foreach($link_list as $key=>$v): ?><tr>
				<td><input type="text" name="listorder[<?php echo ($v["linkageid"]); ?>]" value="<?php echo ($v["listorder"]); ?>" style="width:40px; text-align:center; margin:0 0 0 8px;"/></td>

			    <td style="text-align:center;"><?php echo ($v["linkageid"]); ?></td>
				...
				<a href="__APP__/Link/upLink/cls/3/linkageid/<?php echo ($v["linkageid"]); ?>"  class="btn btn-primary btn-mini">编辑</a> |
				<a href="javascript:void(0);" onclick="del(<?php echo ($v["linkageid"]); ?>,<?php echo ($v["catid"]); ?>);" class="btn btn-danger btn-mini">删除</a>
		  ...
		  <script type="text/javascript">
			...
			function del(val,valone){

				if(confirm("是否删除?")){

					sendRequest(val,valone);

				}

			}

			function sendRequest(val,valone){

				$.ajax({

					   type: "POST",

					   url: "__URL__/delMessage/",

					   data: "mid="+val+"&catid="+valone,
