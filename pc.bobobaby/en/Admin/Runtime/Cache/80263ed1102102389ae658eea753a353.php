...
<nav>
    ...
    <div class="navList">
    	 <ul>
			 ...
			 <li><a <?php if($_GET['cls'] == 7): ?>class="this"<?php endif; ?>  href="__APP__/Try/index/cls/7">试用中心</a></li> 
...
<div id="breadcrumb"> <a href="__APP__/Index/index/cls/1" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>主页</a><span class="nadd">->&nbsp;&nbsp;&nbsp;新建栏目</span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
      ...
      <ul class="quick-actions">
		...
		<li class="bg_lb"> <a href="__URL__/category/cls/2"> <i class="icon-calendar"></i>栏目</a></li>
     ...
     <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
		    ...
		    <form class="myForm" action="__URL__/doCategory/action/add" method="post">
            ...
            <tr>
			  ...
			  <td><input type="text" name="info[catname]" id="name" datatype="*" nullmsg="栏目名为空" />&nbsp;</td>
			...
			<tr>
			  ...
			  <select name="info[parentid]" datatype="*" nullmsg="请选择栏目">
				<option value="0">顶级栏目</option>
					<?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v["catid"]); ?>">
							<?php for($i=0;$i<$v['count'];$i++){ echo '┕'; } ?>
							<?php echo ($v["catname"]); ?>
			...
			<tr>
			  ...
			  <select name="info[model]" datatype="*" nullmsg="请选择模型">
				   ...
				   <option value="Index">单页模型</option>
			  ...
			  <input type="hidden" name="info[tab]" value="" class="mtable"/>
			...
			<tr>
			  ...
			  <td>
				...
				<input type="text" name="info[type]" value="" datatype="*" nullmsg="请填写英文模板"/>
			...
			<input type="text" id="url3" name="info[caturl]"  class="ke-input-text"/> <input type="button" id="image3" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
			...
			<tr>
			  ...
			  <td>
				...
				<input type="text" id="url1" name="info[burl]"  class="ke-input-text"/> <input type="button" id="image1" class="btn btn-success delpic" value="选择图片" style="margin-bottom:10px"/>
			...
			<tr>
			  ...
			  <td><input type="text" name="info[listorder]" value="0"/></td>

			</tr>
			<tr>
			<td>网站导航:</td>
			  <td><input type="radio" name="info[nav]" value="1" />是
				  <input type="radio" name="info[nav]" value="2" checked/>否</td>
			</tr>
