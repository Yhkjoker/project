...
<div class="quick-actions_homepage">
 ...
 <div class="row-fluid">
     ...
     <div class="span12">
		...
		<form action="__APP__/Link/doParameter/action/edit/id/<?php echo ($para_arr["id"]); ?>" id="myform" class="myForm" method="post" >	
     	<table class="table table-bordered table-striped">

			  <tr >		  <td width="100px"><span>颜色参数名称：</span></td>		  <td>				<input type="text" name="info[name]" value="<?php echo ($para_arr["name"]); ?>"/>		  </td>		  </tr>				
     	
		  <tr >
		  <td width="100px"><span>颜色参数：</span></td>
		  <td>
			 <div id="picker"></div>
			<input type="hidden" id="colorname" name="info[colorname]" value="<?php echo ($para_arr["colorname"]); ?>" />			<input type="hidden" name="info[typeid]" value="1" />
		  </td>
		  </tr>
...
<script>$('#picker').colpick({    flat:true,    layout:'hex',    submit:0,	color: '<?php echo ($para_arr["colorname"]); ?>',	onChange:function(hsb,hex,rgb,el,bySetColor) {		$("#colorname").attr("value","#"+hex);			}});
  $('.myForm').Validform({
