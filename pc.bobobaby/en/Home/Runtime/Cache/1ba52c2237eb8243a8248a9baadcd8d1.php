...
<?php } ?>
        ...
        <div class="testing-content">
           <!--标题-->
           <h1 class="testing-h1"><img src="__PUBLIC__/img/detectionh1.png"></h1>
           <div class="testing-nei">
...
$(function(){ 
  ...
  var i = 0; //设置当前页数 
   ...
   $(window).load("<?php echo U('Report/getAuto');?>",{page:i,catid:27}, function(data) {
   			i ++;
			$(".testing-nei").append(data); 
  ...
  $(window).scroll(function () { 
    ...
    if(aa<0.02){ 
      $.post("<?php echo U('Report/getAuto');?>",{page:i,catid:27},function(data){ 
        if(data){ 
