...
<?php } ?>
        ...
        <script type="text/javascript">
             ...
             <!--banner-->
             <div class="Canon_banner"><img src="__PUBLIC__/img/baodianbanner.jpg"></div>
             <!--内容-->
             <div class="Canon_content">
                 <h2><?php echo ($con_arr["title"]); ?></h2>
                 <div class="zuozhe"><i>•</i> <span>更新日期：</span> <em><?php echo date("Y.m.d",$con_arr['inputtime']);?></em> <i>•</i>&nbsp;&nbsp;</div>
                 <p><?php echo ($con_arr["content"]); ?></p>    
             </div>
        <div class="Canon_bottom">
             <?php if(empty($front)): ?><a href="#" class="f_left Canon_bottom_left">前一篇<?php else: ?><a href="__URL__/news_xq/catid/<?php echo ($con_arr["catid"]); ?>/id/<?php echo ($front["id"]); ?>" class="f_left Canon_bottom_left">前一篇<?php endif; ?></a>
             <?php if(empty($after)): ?><a href="#" class="f_right Canon_bottom_right">后一篇<?php else: ?><a href="__URL__/news_xq/catid/<?php echo ($con_arr["catid"]); ?>/id/<?php echo ($after["id"]); ?>" class="f_right Canon_bottom_right">后一篇<?php endif; ?></a>
             <a href="<?php echo U('Content/content',array('catid'=>24));?>" class="Canon_bottom_center">返回bobo宝典</a>
        </div>
        <div class="zixun_hdcp">
            <h3>宝典中出现的产品</h3>
            <div class="zixun_hdcp_content">
			<?php if(is_array($pro_list)): foreach($pro_list as $key=>$v): ?><div class="zixun_hdcp_chanpin">
                      <dl>
                          <dt>
                             <img src="<?php echo ($v["picurlpc"]); ?>">
                             <div class="jincai">
                                 <i><?php echo ($v["catname"]); ?></i>
                                 <div class="zixun_hdcp_chanpin_dianji">
                                   <span class="dian-1"></span>
                                   <span class="dian-2"></span>
                                   <span class="dian-3"></span>
                                   <span class="dian-4"></span>
                                  </div>
                             </div>
                             <h4><?php echo ($v["title"]); ?><span><?php echo ($v["capacity"]); ?></span></h4>	
                          </dt>
                          <dd><em><i>￥</i><?php echo ($v["price"]); ?></em>
                            <img class="aixin Product_followBtn1" src="__PUBLIC__/img/botombg.png">
                            <img class="aixin Product_followBtn2" src="__PUBLIC__/img/botombg1.png">
                          </dd>
                      </dl>
