...
<?php } ?>
        ...
        <div class="Journalism_content">
            <div class="Journalism_content_nei">
                <div class="JournalismXx_top">
                    <h2><?php echo ($con_arr["title"]); ?></h2>
                    <h3><span>•</span><?php echo ($con_arr["description"]); ?><span>•</span></h3>
                </div>
                <div class="JournalismXx_center">
                       <?php echo ($con_arr["content"]); ?>
                </div>
                <div class="JournalismXx_bottom">
					<?php if(empty($front)): ?><a class="JournalismXx_switchleft f_left" href="javascript:alert('没有了')">前一篇</a><?php else: ?><a class="JournalismXx_switchleft f_left" href="__URL__/news_xq/catid/<?php echo ($con_arr["catid"]); ?>/id/<?php echo ($front["id"]); ?>">前一篇</a><?php endif; ?>
                    <a class="JournalismXx_bottomcenter" href="<?php echo U('Content/content',array('catid'=>25));?>">返回新闻中心</a>
					<?php if(empty($after)): ?><a class="JournalismXx_switchright f_right" href="javascript:;">后一篇</a><?php else: ?><a class="JournalismXx_switchright f_right"  href="__URL__/news_xq/catid/<?php echo ($con_arr["catid"]); ?>/id/<?php echo ($after["id"]); ?>">后一篇</a><?php endif; ?>
                </div>
            </div>
