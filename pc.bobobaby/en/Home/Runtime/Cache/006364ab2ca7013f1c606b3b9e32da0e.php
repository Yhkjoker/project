...
<?php } ?>
        ...
        <div class="Product_list_content">
            ...
            <div class="Product_list_right f_right">
				...
				<?php if($link_list != null): if(is_array($link_list)): foreach($link_list as $key=>$v): ?><div class="feedingbiaoti"><?php echo ($v["name"]); ?></div>
                    <div class="Product_parameter_photo">
					<?php if(is_array($v[pro_list])): foreach($v[pro_list] as $k=>$vo): ?><div class="Product_photo_single <?php if($k%5 == 0): ?>Product_none<?php endif; ?>">
                            <div class="Product_photo_nei">
							<?php if($vo[xqstatus] == 1): ?><a href="<?php echo U('Product/product_details',array('catid'=>$vo[catid],'pid'=>$vo[id],'ppid'=>$vo[ppid]));?>"><?php else: ?><a href="javascript:alert('此产品已下架')"><?php endif; ?>
                                <div class="Product_photowai">
									<?php if($vo[fmpicurl] == null): ?><img class="Product_photo_img" src="<?php echo ($vo["picurlpc"]); ?>">
									<?php else: ?>
										<img class="Product_photo_img" src="<?php echo ($vo["fmpicurl"]); ?>"><?php endif; ?>
						</div> 
                                    <h3> <?php echo ($cate_arr["catname"]); ?>
						<div class="Product_sekuai">
					<?php $color_count=count($vo['colorlist']);?>
							<?php if($color_count > 1): if(is_array($vo[colorlist])): foreach($vo[colorlist] as $key=>$val): ?><span style="background-color:<?php echo ($val["colorname"]); ?>"></span><?php endforeach; endif; endif; ?>
					
				
			  </div>
            </h3>
                                    <h2><?php echo ($vo["title"]); ?><span><?php echo ($vo["capacity"]); ?></span></h2>                 </a>
                                    <div class="Product_price">
                                        <h4><i>￥</i>
											...
											<?php }else{?>
												<?php if($vo[colid] ): ?><a href="javascript:collect_del(<?php echo ($vo[colid]); ?>);"><img class="Product_follow Product_followBtn1" src="__PUBLIC__/img/botombg1.png"></a>
													<?php else: ?>
														<a href="javascript:collect_tj(<?php echo ($vo["ppid"]); ?>);"><img class="Product_follow Product_followBtn1" src="__PUBLIC__/img/botombg.png"></a><?php endif; ?>
				...
				<?php if(is_array($pro_list_fw)): foreach($pro_list_fw as $key=>$v): ?><div class="Product_document_nei">
                         ...
                         <div class="Product_document_cnei">
						 		   <?php if($v["status"] == 1 || $v[xqstatus] == 1): ?><a href="<?php echo U('Product/product_details',array('catid'=>$v[catid],'pid'=>$v[pid],'ppid'=>$v[id]));?>"><?php else: ?><a href="javascript:alert('此产品已下架');"><?php endif; ?>
                             <div class="Product_photowai">
                           ...
                           <?php $color_count_one=count($v['colorlist']);?>
                                ...
                                <h2><?php echo ($v["title"]); ?><span><?php echo ($v["capacity"]); ?></span></h2>				  </a>
...
<script type="text/javascript">
    ...
    $('.Product_sekuai span').click(function() {
        ...
        /*内容图片*/
        $('.Product_photo_nei').hover(function() {
