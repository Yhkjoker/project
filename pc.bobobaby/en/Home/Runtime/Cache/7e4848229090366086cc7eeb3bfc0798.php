...
<?php } ?>
        ...
        <div class="banner">
            <div class="inner">
				...
				<?php if(is_array($index_pic_banner)): foreach($index_pic_banner as $key=>$v): ?><li>
                        <a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picurl"]); ?>"></a>
        ...
        <div class="products-catalog">
            <div class="inner">
                <div class="row cp-goldd">
				  <?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 11): ?><div class="col-md-62"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picurl"]); ?>"></a></div>
						<div class="col-md-38"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picwzurl"]); ?>"></a></div><?php endif; endforeach; endif; ?>	
                </div>
                <div class="row cp-gold">
				<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 12): ?><div class="col-md-38"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picwzurl"]); ?>"></a></div>
						<div class="col-md-62"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picurl"]); ?>"></a></div><?php endif; endforeach; endif; ?>	
                </div>
                <div class="row">
                    <div class="col-md-50">
					<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 13): ?><a href="<?php echo ($v["vidurl"]); ?>" class="products-feeding"><img src="<?php echo ($v["picwzurl"]); ?>"></a>
							<img src="<?php echo ($v["picurl"]); ?>"><?php endif; endforeach; endif; ?>	
                    </div>
                    <div class="col-md-50">
					<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 14): ?><a href="<?php echo ($v["vidurl"]); ?>" class="products-tableware"><img src="<?php echo ($v["picwzurl"]); ?>"></a>
							<img src="<?php echo ($v["picurl"]); ?>"><?php endif; endforeach; endif; ?>	
                    </div>
                </div>
                <div class="row cp-motherscat">
				<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 15): ?><div class="col-md-62"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picurl"]); ?>"></a></div>
                    <div class="col-md-38"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picwzurl"]); ?>"></a></div><?php endif; endforeach; endif; ?>	
                </div>
                <div class="row cp-oralcare">
				<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 16): ?><div class="col-md-38"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picwzurl"]); ?>"></a></div>
                    <div class="col-md-62"><a href="<?php echo ($v["vidurl"]); ?>"><img src="<?php echo ($v["picurl"]); ?>"></a></div><?php endif; endforeach; endif; ?>	
                </div>
                <div class="row">
                    <div class="col-md-50">
					<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 17): ?><a href="<?php echo ($v["vidurl"]); ?>" class="products-household"><img src="<?php echo ($v["picwzurl"]); ?>"></a>
							<img src="<?php echo ($v["picurl"]); ?>"><?php endif; endforeach; endif; ?>	
                    </div>
                    <div class="col-md-50">
					<?php if(is_array($index_pic_list)): foreach($index_pic_list as $key=>$v): if($v[id] == 18): ?><a href="<?php echo ($v["vidurl"]); ?>" class="products-accessories"><img src="<?php echo ($v["picwzurl"]); ?>"></a>
							<img src="<?php echo ($v["picurl"]); ?>"><?php endif; endforeach; endif; ?>	
                    </div>
                </div>
            </div>
        ...
        <div class="bobo-around">
            <div class="inner">
                <div class="bobo-knowledge">
                    <a href="<?php echo U('Content/content',array('catid'=>24));?>"><span>- Parenting Tips -</span><img src="__PUBLIC__/img/icon-btn-knowledge.png"></a>
                </div>
                <div class="bobo-news">
                    <a href="<?php echo U('Content/content',array('catid'=>25));?>"><span>- News -</span><img src="__PUBLIC__/img/icon-btn-news.png"></a>
                </div>
                <div class="bobo-event">
                    <a href="<?php echo U('Content/content',array('catid'=>23));?>"><span>- Activity Info -</span><img src="__PUBLIC__/img/icon-btn-event.png"></a>
                </div>
            </div>
            <div class="tel">
                <img src="__PUBLIC__/img/icon-tel.png">
                <i class="icon-tel"></i>
            </div>
        </div>
		    <!-- footer -->
        <div class="footer">
            <a href="__APP__/Index/about/catid/29" class="btn-about"><img src="__PUBLIC__/img/btn-about.png"></a>
