...
Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var on=e.jQuery,an=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=an),t&&e.jQuery===ie&&(e.jQuery=on),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),jQuery(function(e){e('a[href="###"]').on("click",function(e){event.stopPropagation(),event.preventDefault()}),e(".nav-bar>li").not(".active").hover(function(t){e(this).prev().addClass("near")},function(t){e(this).prev().removeClass("near")}),e(".cp-list>ul>li>a").hover(function(){var t=e(this).parent();t.parent().find("li").removeClass("active"),t.addClass("active");var n=e(this).attr("data-img");t.parent().parent().parent().find(".cp-photo").hide().find("img").attr("src",n).parent().slideDown()},function(){}),e(".cp-catalog>li>a").hover(function(t){var n=e(this).parent();n.parent().find("li").removeClass("active"),n.addClass("active");var r=e("#"+e(this).attr("data-for"));r.parent().find("ul").hide(),r.stop().show(),r.parent().parent().find(".cp-photo").stop().hide().find("img").attr("src",r.find(".active").attr("data-img")).parent().slideDown()},function(e){}),e(".btn-about").on("click",function(t){e(this).next().slideToggle();var n=e(window).scrollTop()+100;e("html,body").animate({scrollTop:n},500,function(){})})});