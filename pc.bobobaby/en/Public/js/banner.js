...
var banner = function(Box,Width,Height,Left,Top,Amw,Amr){
	...
	document.write(".product_contentLeftTop{width:100%; min-width:"+cssWidth+"px; height:"+cssHeight+"px; position:fixed; padding-bottom:50px;}");
	...
	document.write(".product_contentLeftTop .banner_a{position:absolute; bottom:20px; left:55%; width:100%; text-align:center;}");
