...
<!--内容-->
<div id="content">
<div id="breadcrumb"> <a href="__APP__/Index/index" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>主页</a>->添加材质参数</span></div>
...
		<tr >		  <td width="100px"><span>材质名称：</span></td>		  <td>				<input type="text" name="info[colorname]" />				<input type="hidden" name="info[typeid]" value="2" />		  </td>		  </tr>				
