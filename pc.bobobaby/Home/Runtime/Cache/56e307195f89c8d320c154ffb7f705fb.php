...
<?php } ?>
        ...
        <div class="Product_list_content shiyong">
            ...
            <div class="Product_list_right f_right">
				<?php if($try_arr ): ?><div class="Product_list_right_photo">
                ...
                <div class="Product_list_right_content">
                    <div class="Product_list_right_contentTop">
                        <div class="Product_list_right_contentSenqing">
                            <?php if($try_arr["status"] == 1): ?><img class="Product_list_right_contentTopImg" src="/bobo2/Public/img/sq1.jpg" />
							<?php elseif($try_arr["status"] == 2): ?>
								<img class="Product_list_right_contentTopImg" src="/bobo2/Public/img/sq2.jpg" />
							<?php elseif($try_arr["status"] == 3): ?>
								<img class="Product_list_right_contentTopImg" src="/bobo2/Public/img/sq3.jpg" />
							<?php elseif($try_arr["status"] == 4): ?>
								<img class="Product_list_right_contentTopImg" src="/bobo2/Public/img/sq3.jpg" />
							<?php elseif($try_arr["status"] == 5): ?>
								<img class="Product_list_right_contentTopImg" src="/bobo2/Public/img/sq3.jpg" />							
							<?php elseif($try_arr["status"] == 0): ?>
								<img class="Product_list_right_contentTopImg" src="/bobo2/Public/img/sq4.jpg" /><?php endif; ?>
							   <div class="Product_list_right_contentSenqing02">
								 <?php if($try_arr["status"] == 2): ?><input class="Product_list_right_contentSenqingBtn01" type="button" value="填写地址" onclick="window.location.href='<?php echo U('Try/address',array('cls'=>$_GET[cls],'id'=>$try_arr[id]));?>'" />
                                <input class="Product_list_right_contentSenqingBtn02" type="button" value="取消申请" onclick="ajaxdel()"/><?php endif; ?>
								<?php if($try_arr["status"] == 3 || $try_arr["status"] == 4): ?><input class="Product_list_right_contentSenqingBtn03" type="button" value="回答问卷" <?php if($try_arr[status] == 3): ?>onclick="alertt()"<?php else: ?>onclick="window.location.href='<?php echo U('Try/questionnaire',array('cls'=>2,'pid'=>$try_arr[pid],'id'=>$try_arr[id]));?>'"<?php endif; ?> /><?php endif; ?>
                            </div>
                        </div>
					...
					<?php if($try_list ): ?><div class="Product_list_right_contentBottom">
                       ...
                       <ul>
						...
						<?php if(is_array($try_list)): foreach($try_list as $key=>$v): ?><li>
                              <a href="__APP__/Try/schedule/cls/2/id/<?php echo ($v["id"]); ?>"><img class="Product_list_right_contentBottom_photo01" src="<?php echo ($v["picurlpc"]); ?>" />
        ...
        <!-- 2016-05-24修改弹窗样式 -->
         ...
         <div class="shiyongtclbBg"><img class="shiyongtclbBgGb" src="/bobo2/Public/img/gbbg.png" /></div>
         <div class="shiyongtclb">
             <i class="cuoicon"></i>
             <p class="tanchaungtxt">等待卖家发货！</p>
         </div>
...
<script>
	...
	function ajaxdel(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo U('Try/cancelRequest');?>",
			data:"id="+<?php echo ($try_arr["id"]); ?>,
