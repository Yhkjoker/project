...
class CommonAction extends Action {
    public function __construct(){
		...
		$pro_db=M("Product");
		$pro_header=$pro_db->field("a.xqstatus,a.title,a.picurlpc,a.catid,a.id,b.id as ppid")->table("tp_product_price b,tp_product a")->where("a.posid=1 and a.status=1 and  a.id=b.pid")->order("a.listorder desc,id desc")->limit(8)->select();
		$video_db=M("Video");
